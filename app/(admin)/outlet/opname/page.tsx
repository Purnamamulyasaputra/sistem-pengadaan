...
export default function OutletOpnamePage() {
  ...
  const fetchSessions = useCallback(async () => {
    setLoading(true);
    const res = await fetch(`/api/opname?location_type=OUTLET&location_id=${OUTLET_ID}`);
        ...
        <div className="card-body flush">
          {loading ? (
            ...
            <div className="empty-state">
              ...
              <p>You haven't conducted any stock opname yet.</p>
            ...
            <Table>
              <thead>
                <tr>
                  <th>Opname Date</th>
                  <th>Conducted By</th>
                  <th className="right">Usage Cost (Value)</th>
